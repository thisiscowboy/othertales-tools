...
class TestFilesystemAPI:
    ...
    def test_read_file(self, mock_fs_service):
        ...
        response = client.post(
            "/fs/read",
            json={"path": "/test/file.txt", "storage": "local"}
        )
    ...
    def test_search_files(self, mock_fs_service):
        # Mock the service
        mock_fs_service.search_files.return_value = [
            "/test/file1.txt",
    ...
    def test_create_directory(self, mock_fs_service):
        # Mock the service
        mock_fs_service.create_directory.return_value = "Successfully created directory /test/newdir"
